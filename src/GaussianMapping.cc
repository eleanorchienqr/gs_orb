...
bool GaussianMapping::CheckNewKeyFrames()
{
    unique_lock<mutex> lock(mMutexNewKFs);
...
void GaussianMapping::MapPointCulling()
{
...
void GaussianMapping::CreateNewMapPoints()
{
...
void GaussianMapping::SearchInNeighbors()
{
...
void GaussianMapping::RequestStop()
{
...
bool GaussianMapping::isStopped()
{
    unique_lock<mutex> lock(mMutexStop);
    return mbStopped;
}

bool GaussianMapping::stopRequested()
{
    unique_lock<mutex> lock(mMutexStop);
    return mbStopRequested;
}

void GaussianMapping::Release()
{
    unique_lock<mutex> lock(mMutexStop);
...
bool GaussianMapping::AcceptKeyFrames()
{
    unique_lock<mutex> lock(mMutexAccept);
    return mbAcceptKeyFrames;
}

void GaussianMapping::SetAcceptKeyFrames(bool flag)
{
    unique_lock<mutex> lock(mMutexAccept);
    mbAcceptKeyFrames=flag;
}

bool GaussianMapping::SetNotStop(bool flag)
{
    unique_lock<mutex> lock(mMutexStop);
...
void GaussianMapping::InterruptBA()
{
    mbAbortBA = true;
}

void GaussianMapping::KeyFrameCulling()
{
...
void GaussianMapping::RequestReset()
{
    {
...
void GaussianMapping::RequestResetActiveMap(Map* pMap)
{
    {
        unique_lock<mutex> lock(mMutexReset);
...
void GaussianMapping::ResetIfRequested()
{
...
void GaussianMapping::RequestFinish()
{
    unique_lock<mutex> lock(mMutexFinish);
    mbFinishRequested = true;
}

bool GaussianMapping::CheckFinish()
{
    unique_lock<mutex> lock(mMutexFinish);
    return mbFinishRequested;
}

void GaussianMapping::SetFinish()
{
    unique_lock<mutex> lock(mMutexFinish);
    mbFinished = true;    
...
bool GaussianMapping::isFinished()
{
    unique_lock<mutex> lock(mMutexFinish);
    return mbFinished;
}

void GaussianMapping::InitializeIMU(float priorG, float priorA, bool bFIBA)
{
    if (mbResetRequested)
        return;
...
void GaussianMapping::ScaleRefinement()
{
...
bool GaussianMapping::IsInitializing()
{
    return bInitializing;
}


double GaussianMapping::GetCurrKFTime()
{
...
KeyFrame* GaussianMapping::GetCurrKF()
{
